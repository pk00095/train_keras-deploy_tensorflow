...
class Recorder:
 ...
 def imgs_input_fn(self,filenames,height,width,shuffle=False,repeat_count=1,batch_size=32):
    ...
    iterator = dataset.make_one_shot_iterator()   # Make an iterator
    batch_features,batch_labels = iterators.get_next()  # Tensors to get next batch of image and their labels
